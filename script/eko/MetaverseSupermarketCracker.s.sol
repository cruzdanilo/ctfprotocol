...
import { MetaverseSupermarketCracker, InflaStore } from "../../src/eko/MetaverseSupermarketCracker.sol";

contract MetaverseSupermarketCrackerScript is Script {
  function run() external {
    InflaStore store = InflaStore(vm.envAddress("EKO_INFLA_STORE_ADDRESS"));
